 ...
 * For intelligent checks (command accuracy, architecture drift), use /gov:check instead.
 */
function check(flags) {
  ...
  const checks = [
    ...
    },
    {
      ...
      fix: 'Run /gov:init to generate governance sections',
    },
    {
    ...
    },
    {
      ...
      fix: 'Run /gov:init to replace template placeholders',
    },
    {
    ...
    },
    {
      ...
      pass: fs.existsSync(path.join(claudeDir, 'commands', 'gov')),
      fix: 'npx kdutool install <preset>',
    },
    {
  ...
  if (failed === 0) {
    ...
    console.log('  💡 For deeper analysis (command accuracy, architecture drift), run /gov:check\n');
  } else {
